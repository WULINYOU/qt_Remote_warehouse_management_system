...
public:
    ...
    void setupUi(QDialog *registec)
    {
        ...
        add_comment = new QLineEdit(widget1);
        ...
        add_username = new QLineEdit(widget1);
        ...
        add_password = new QLineEdit(widget1);
        ...
        add_password_again = new QLineEdit(widget1);
        ...
        ask_number = new QLineEdit(widget1);
